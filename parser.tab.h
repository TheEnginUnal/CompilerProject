...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOKEN_INEQUALITY = 280,        /* TOKEN_INEQUALITY  */
    TOKEN_LESS_EQUAL = 281,        /* TOKEN_LESS_EQUAL  */
    TOKEN_GREATER_EQUAL = 282,     /* TOKEN_GREATER_EQUAL  */
    TOKEN_LOGICAL_AND = 283,       /* TOKEN_LOGICAL_AND  */
    TOKEN_LOGICAL_OR = 284,        /* TOKEN_LOGICAL_OR  */
